...
## IV. Authentication and Permission System: JWT + Middleware Loop

Why design it this way?

> Permission security is the core of backend systems. Declarative permissions + caching mechanism achieve both security and performance, clear structure also facilitates AI collaboration.

### 4.1 Middleware Architecture

#### Core Middleware Components

- ✅ **JWT Validation Middleware**: Extract user information, verify token validity
- ✅ **Permission Verification Middleware**: Permission control based on `PermissionsCheck`
...
pub async fn permission_middleware(
    ...
    // If insufficient permissions, return error
    if !has_permission {
...
- ✅ **Automatic Cache Expiration Cleanup**: 1-hour expiration, forces user re-authentication
...
- ⚙️ **Future Extensions**: refresh token and online session management
...
Rustzen is not deliberately catering to AI, but **clear code written for humans** happens to make AI collaboration better:
...
- ✅ **Security**: Perfect cache expiration mechanism, forced re-authentication
